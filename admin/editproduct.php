...
<form action="" method="POST" enctype="multipart/form-data">
  ...
  <tr>
    <td class="table-title" colspan="2" style="color:white;text-align:center;font-weight:bolder;text-transform:uppercase;">Edit Product</td>
  </tr>
<tr>
  <td>Title</td>
...
<tr>
  <td>Manufacturer</td>
  <td><input type="text" name="manufacturer" value="<?php echo $p['manufacturer']; ?>" required></td>
</tr>
<tr>
  <td>Description</td>
  <td><textarea type="text" name="description" required><?php echo $p['description']; ?></textarea></td>
</tr>
<tr>
...
<tr>
  <td colspan="2" class="text-center"><input type="submit" value="Update" class="button success"></td>
</tr>
</table>
